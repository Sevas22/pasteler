  ...
  return (
    <LayoutShell>
      ...
      <div className="mx-auto max-w-lg px-4 py-24 text-center">
        <h1 className="font-serif text-3xl font-normal text-heading">Producto no encontrado</h1>
        <p className="mt-4 text-muted-foreground">Ese servicio no existe o fue movido.</p>
        <Link
          href="/productos"
